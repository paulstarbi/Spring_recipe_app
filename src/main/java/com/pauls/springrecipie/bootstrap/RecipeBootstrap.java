package com.pauls.springrecipie.bootstrap;

import com.pauls.springrecipie.model.*;
import com.pauls.springrecipie.repositories.CategoryRepository;
import com.pauls.springrecipie.repositories.RecipeRepository;
import com.pauls.springrecipie.repositories.UnitOfMeasureRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacNotes.setReciepieNotes("For a very quick guacamole just take a 1/4 cup of salsa and mix it in with your mashed avocados.\n" +
        ...
        tacoNotes.setReciepieNotes("We have a family motto and it is this: Everything goes better in a tortilla.\n" +
